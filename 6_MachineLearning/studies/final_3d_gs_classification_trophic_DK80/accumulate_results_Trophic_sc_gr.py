"""
We aim here to accumulate the results from the different classification scenarios
studied.
...
path_results = path_repo / "Results" / "final_3d_gs_classification_trophic_DK80_sc_gr"
